/* ==========================================================================================
 * NOT COMPILED. This is a tracked copy of a build input that lives outside the repository.
 *
 * The real file is at  Documents/Arduino/libraries/lv_conf.h  — beside the `lvgl` folder, not
 * inside it, which is where the Arduino IDE looks for it. Nothing in this repo can pin it, so
 * reinstalling or updating LVGL silently reverts the configuration and the firmware starts
 * behaving differently for no visible reason.
 *
 * Kept here so that failure is diagnosable: diff this against the live file.
 *
 * The settings that this project actually depends on are listed in docs/hardware-notes.md
 * under "LVGL configuration". Everything below this block is verbatim.
 * ========================================================================================== */
